...
const Hero = () => {
  ...
  return <section id="home" ref={ref} className="relative min-h-screen flex items-center justify-center px-4 lg:px-6 pt-24 pb-12 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        <div 
          className="absolute top-20 right-10 w-64 h-64 bg-primary/10 rounded-full blur-3xl animate-float"
        ...
        ></div>
        <div 
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-gradient-to-b from-primary/5 to-transparent blur-2xl"
          style={{ transform: `translate(-50%, ${-50 + scrollY * 0.2}%)` }}
        ></div>
      </div>

      <div 
        className={`max-w-7xl w-full text-center space-y-6 lg:space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
      ...
      >
        ...
        {/* Tagline */}
        <div className="max-w-3xl mx-auto space-y-3 lg:space-y-4 animate-fade-in-up" style={{ animationDelay: '0.2s', animationFillMode: 'backwards' }}>
        ...
        {/* Contact Info */}
        <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 sm:gap-6 text-sm lg:text-base text-muted-foreground animate-fade-in-up" style={{ animationDelay: '0.4s', animationFillMode: 'backwards' }}>
        ...
        {/* Social Links */}
        <div className="flex gap-3 lg:gap-4 justify-center pt-2 lg:pt-4 animate-scale-in" style={{ animationDelay: '0.6s', animationFillMode: 'backwards' }}>
