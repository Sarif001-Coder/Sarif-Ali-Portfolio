...
const Training = () => {
  ...
  return <section id="training" ref={ref} className={`py-16 px-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl lg:text-4xl font-bold mb-4">DevOps Training</h2>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-8">
          {skills.map((skill, index) => <Card key={index} className="bg-card border-border p-5 hover:border-primary/50 hover:scale-105 transition-all duration-300">
